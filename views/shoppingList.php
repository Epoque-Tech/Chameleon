...
<div class="row mainRow">
    <section class="col-md-8 col-md-offset-1 col-lg-offset-2">
      ...
      <div class="row">
        <div class="col-xs-9 col-md-10">
            <input id="shoppingListInput" type="text">
        </div>
        <div class="col-xs-2 col-md-2">
            <button id="addToShoppingList" class="btn btn-primary">Add</button>
        </div>
      </div>
    ...
    <div id="shoppingListConfirmDeleteModal" class="modal fade" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">Remove Item from Shopping List</h4>
          </div>
    ...
    <script src="<?php echo JS_DIR.'shoppingList.js'; ?>"></script>
</div>
